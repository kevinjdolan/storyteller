...
class GeminiCharacterGenerationAdapter:
    ...
    def generate(
        ...
        log_event(
            ...
            logging.INFO,
            "ai.request.started",
            "Gemini character generation started.",
        ...
        try:
            ...
            log_event(
                ...
                "Gemini character generation succeeded.",
                operation="character_generation",
                model_id=self._model_id,
                prompt_version=invocation.prompt_version,
        ...
        except CharacterGenerationTransportError as exc:
            self._log_failure(
                prompt_version=invocation.prompt_version,
    ...
    def _build_retry_notifier(
        ...
        def notifier(notice: GeminiRetryNotice) -> None:
            log_event(
                ...
                "Gemini character generation retry scheduled.",
                operation="character_generation",
                model_id=self._model_id,
    ...
    def _log_failure(
        ...
        *,
        ...
        log_event(
            ...
            logging.ERROR,
            "ai.request.failed",
            "Gemini character generation failed.",
            operation="character_generation",
            model_id=self._model_id,
            prompt_version=prompt_version,
